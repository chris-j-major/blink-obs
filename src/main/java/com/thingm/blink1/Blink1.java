...
public abstract class Blink1 
{
   ...
   * @return < 0 on error, or number of bytes received
   */
  ...
  public int setRGB(int r, int g, int b) {
    ...
    return this.sendFeatureReport(buff, reportId);
  }
   ...
   *
   * @return blink1 version number as int (e.g. v1.0 == 100, v2.0 = 200)
   */
  ...
  public PatternLine readPatternLine(int pos) {
    ...
    return new PatternLine(fadeMillis, r,g,b, ledn);
  }
  ...
  public int playPattern(PatternLine[] patternlines, boolean clear) {
    ...
    if(rc<0) return rc;
    return this.play(0,patternlines.length,0 /* implies play forever */);
  }
   ...
   */
  public static int log2lin(int n ) {
